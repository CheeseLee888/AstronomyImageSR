# file to create heat map with local image stability
...
img_path_0 = "img_results_10_2/test_20160226_0.fits"
img_path_1 = "img_results_10_2/test_20160226_1.fits"
img_path_2 = "img_results_10_2/test_20160226_2.fits"
img_path_3 = "img_results_10_2/test_20160226_3.fits"
img_path_4 = "img_results_10_2/test_20160226_4.fits"
img_path_5 = "img_results_10_2/test_20160226_5.fits"
img_path_6 = "img_results_10_2/test_20160226_6.fits"
img_path_7 = "img_results_10_2/test_20160226_7.fits"
img_path_8 = "img_results_10_2/test_20160226_8.fits"
img_path_9 = "img_results_10_2/test_20160226_9.fits"
...
plt.savefig("heatmap/10_001/20160226_heatmap.png")
plt.close()

# detect background of HR image

hr_20160226 = "sr_data/hr_images/20160226.fits"
...
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.savefig("heatmap/10_001/weighted_array_differences_20160226.png")
plt.close()
...
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.savefig("heatmap/10_001/weighted_array_hr_20160226.png")
plt.close()
...
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.savefig("heatmap/10_001/weighted_array_sr_20160226.png")
plt.close()
