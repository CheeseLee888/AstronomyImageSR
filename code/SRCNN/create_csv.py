...
image_dataset_name = 'fits' # image dataset folder name
image_format = 'fits' # 'tif' or 'fits'
...
se_hr_dir = '../../data_demo/Prep_Images/'+image_dataset_name+'_se_hr_'+change # input: selective HR and LR images from preparation step
se_lr_dir = '../../data_demo/Prep_Images/'+image_dataset_name+'_se_lr_'+change
